...

{
	...
	Mat im1Gray=im1_1, im2Gray=im2_1;
	...
	// Draw top matches
	Mat imMatches;
	drawMatches(im1_1, keypoints1, im2_1, keypoints2, matches, imMatches);
...
int main(int argc, char **argv)
{
	...
	string refFilename("C:\\adani_data_correction\\sample_2\\000.tif");
	...
	string imFilename("C:\\adani_data_correction\\sample_2\\062.tif");
