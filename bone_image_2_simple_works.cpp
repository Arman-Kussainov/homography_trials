...
int main(int argc, char **argv)
{
	...
	string refFilename("C:\\6_OpenCV_homography\\bone_images_copy2\\bone_image_2\\30.png");
	cout << "Reading reference image : " << refFilename << endl;
	Mat imReference = imread(refFilename);


	// Read image to be aligned
	string imFilename("C:\\6_OpenCV_homography\\bone_images_copy2\\bone_image_2\\32.png");
